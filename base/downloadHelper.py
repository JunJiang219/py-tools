...
def download_batch(urls, save_dir, max_workers=8, target_subdir="download", del_dir_existed=False):
    """
    批量下载图片并重命名临时目录
    ...
    :param del_dir_existed: 是否删除已存在的目标目录（默认为False）download
    """
